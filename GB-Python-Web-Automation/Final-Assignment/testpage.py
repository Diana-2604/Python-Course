...
class TestSearchLocators:
    ...
    LOCATOR_ABOUT_TITLE = (By.XPATH, """//*[@id="app"]/main/div/div/h1""")
...
class OperationsHelper(BasePage):
    ...
    def get_about_title_text(self):
        about_title = self.find_element(TestSearchLocators.LOCATOR_ABOUT_TITLE)
        return about_title.text

    def get_about_title_font_size(self):
        about_title = self.find_element(TestSearchLocators.LOCATOR_ABOUT_TITLE)
        return about_title.value_of_css_property("font-size")
